...
- **snappiness held** (every category-specific latency contract passed: strict
  per-sample where specified, otherwise p99 plus hard-stall ceiling), AND
